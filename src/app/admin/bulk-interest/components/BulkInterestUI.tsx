  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-8 pb-32">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-[#0B2E59] uppercase tracking-tight flex items-center gap-3">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
          <div>
             <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1">Global Interest Rate (ब्याज दर)</label>
      ...
      {/* Global Actions */}
      <div className="bg-white border-2 border-[#0B2E59] rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-4 bg-gray-50 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
           <div className="relative w-full sm:w-96">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium text-sm"
              />
           </div>
             ...
             <tbody className="bg-white divide-y divide-gray-200">
                {filteredCustomers.length === 0 ? (
                  ...
                  filteredCustomers.map((cust) => {
                    ...
                    return (
                      <tr key={cust.id} className={`transition-colors ${isSelected ? 'bg-blue-50/30' : 'hover:bg-gray-50'}`}>
                         ...
                         <td className="p-4 border-r border-gray-100">
                            ...
                            <p className="text-xs font-semibold text-gray-500 mt-0.5">{cust.mobile}</p>
                         </td>
                         ...
                         <td className="p-3 bg-purple-50/30">
                            <input 
                              ...
                              className={`w-full text-right p-2 border rounded-md text-sm font-bold focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors ${
                                hasOverride ? 'border-purple-400 bg-purple-50 text-purple-900' : 'border-gray-200 bg-white text-gray-900'
      ...
      {/* Floating Action Bar */}
      <div className="fixed bottom-0 left-0 right-0 md:left-64 bg-white border-t border-gray-200 p-4 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.1)] flex flex-col sm:flex-row justify-between items-center gap-4 z-40">
         <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
               <HandCoins className="w-6 h-6 text-purple-600" />
            </div>
            <div>
               <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">Total Payout Amount (कुल भुगतान राशि)</p>
         ...
         <button 
           ...
           className="w-full sm:w-auto bg-[#0B2E59] hover:bg-[#071f3e] disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-3 px-8 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 tracking-widest uppercase text-sm"
         >
