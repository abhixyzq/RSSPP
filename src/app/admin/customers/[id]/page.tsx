  ...
  return (
    <div className="max-w-[1200px] mx-auto pb-20 p-4 sm:p-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
         <Link href="/admin/customers" className="flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-blue-600 transition-colors font-semibold bg-white dark:bg-slate-900 px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-700 shadow-sm">
      ...
      <div className="bg-white dark:bg-slate-900 shadow-md border border-gray-300 dark:border-slate-700">
         ...
         <div className="bg-[#0B2E59] dark:bg-blue-900 text-white p-6 border-b-4 border-[#0099CC] flex flex-col sm:flex-row items-start sm:items-center gap-4">
         ...
         <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 border-b border-gray-200 dark:border-slate-700 bg-gray-50/50">
            <div className="space-y-3">
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">Account Name</span>
               ...
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">Account No.</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-gray-100 col-span-2">{profile.mobile_number}</span>
               </div>
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">Address</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-gray-100 col-span-2 uppercase">
                    {profile.address || 'N/A'}
            ...
            <div className="space-y-3">
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">Status</span>
               ...
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">KYC Status</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-gray-100 col-span-2 uppercase">{profile.kyc_document || 'PENDING'}</span>
               </div>
               <div className="grid grid-cols-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-bold uppercase col-span-1">Occupation</span>
                  <span className="text-sm font-bold text-gray-900 dark:text-gray-100 col-span-2 uppercase">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6 bg-transparent">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-4 group">
               ...
               <div>
                  <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider group-hover:text-green-600 transition-colors">Deposit Balance (कुल बचत)</p>
                  <p className="text-2xl font-black text-gray-900 dark:text-gray-100 mt-0.5">₹{currentJamaBalance.toLocaleString('en-IN')}</p>
               </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-4 group">
               ...
               <div>
                  <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider group-hover:text-red-600 transition-colors">Loan Balance (कुल ऋण)</p>
                  <p className="text-2xl font-black text-gray-900 dark:text-gray-100 mt-0.5">₹{currentNikasiBalance.toLocaleString('en-IN')}</p>
               </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-4 group">
               ...
               <div>
                  <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider group-hover:text-purple-600 transition-colors">Interest Earned (कुल ब्याज मिला)</p>
                  <p className="text-2xl font-black text-gray-900 dark:text-gray-100 mt-0.5">₹{totalJamaInterest.toLocaleString('en-IN')}</p>
               </div>
            </div>
         </div>

         {/* DEPOSIT LEDGER */}
         <div className="p-0 sm:p-6 overflow-x-auto border-b-4 border-gray-300 dark:border-slate-700">
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
               <thead>
                  <tr className="bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 text-[12px] uppercase tracking-wider border-b-2 border-gray-300 dark:border-slate-700">
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-32">Date (दिनांक)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700">Particulars (विवरण)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-32 text-right text-purple-800 bg-purple-50">Interest Earned (ब्याज मिला)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-40 text-right">Amount (राशि) (+ / -)</th>
               ...
               <tbody className="bg-white dark:bg-slate-900">
                  {(!jamaTransactions || jamaTransactions.length === 0) ? (
                    ...
                    jamaTransactions.map((tx, index) => {
                      ...
                      const bgClass = index % 2 === 0 ? 'bg-white dark:bg-slate-900' : 'bg-gray-50 dark:bg-slate-800/50';
                      ...
                      return (
                        <tr key={tx.id} className={`${bgClass} hover:bg-green-50/50 text-[13px] text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700`}>
                           <td className="p-3 border-r border-gray-200 dark:border-slate-700 font-medium">
                           ...
                           <td className="p-3 border-r border-gray-200 dark:border-slate-700 text-right font-extrabold text-purple-700 bg-purple-50/30">
                              {isInterest ? `+${interestString}` : '-'}
                           </td>
                           <td className={`p-3 border-r border-gray-200 dark:border-slate-700 text-right font-bold ${isInterest ? 'text-gray-400' : isDeposit ? 'text-green-700' : 'text-red-600'}`}>
                              {isInterest ? '-' : isDeposit ? `+ ${amtString}` : `- ${amtString}`}
                           </td>
                           <td className="p-3 text-right font-extrabold text-gray-900 dark:text-gray-100 bg-green-50/30">
                              {balString}
                           </td>
                        </tr>
                      )
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
               <thead>
                  <tr className="bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 text-[12px] uppercase tracking-wider border-b-2 border-gray-300 dark:border-slate-700">
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-32">Date (दिनांक)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700">Particulars (विवरण)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-32 text-right">Principal (मूलधन) (+/-)</th>
                     <th className="p-3 font-bold border-r border-gray-300 dark:border-slate-700 w-32 text-right">Interest Paid (ब्याज दिया)</th>
               ...
               <tbody className="bg-white dark:bg-slate-900">
                  {(!nikasiTransactions || nikasiTransactions.length === 0) ? (
                    ...
                    nikasiTransactions.map((tx, index) => {
                      ...
                      return (
                        <tr key={tx.id} className={`${bgClass} hover:bg-red-50/50 text-[13px] text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700`}>
                           <td className="p-3 border-r border-gray-200 dark:border-slate-700 font-medium">
                              {new Date(tx.transaction_date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}
                           </td>
                           <td className="p-3 border-r border-gray-200 dark:border-slate-700 font-medium">
                           ...
                           <td className={`p-3 border-r border-gray-200 dark:border-slate-700 text-right font-bold ${isLoanGiven ? 'text-red-700' : isPrincipalRepay ? 'text-green-700' : 'text-gray-400'}`}>
                              {isLoanGiven ? `+ ${amtString}` : isPrincipalRepay ? `- ${amtString}` : '-'}
                           </td>
                           <td className={`p-3 border-r border-gray-200 dark:border-slate-700 text-right font-bold ${isInterest ? 'text-purple-700' : 'text-gray-400'}`}>
                              {isInterest ? amtString : '-'}
                           </td>
                           <td className="p-3 text-right font-extrabold text-gray-900 dark:text-gray-100 bg-red-50/30">
                              {balString}
                           </td>
                        </tr>
                      )
         ...
         <div className="p-4 border-t border-gray-300 dark:border-slate-700 bg-gray-100 dark:bg-slate-800 text-center mt-4">
