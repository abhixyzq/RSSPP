      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 flex-1 flex flex-col justify-center py-8 lg:py-0 lg:min-h-0 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="hidden lg:block space-y-8 relative">
            ...
            <div className="inline-flex items-center gap-3 px-3 py-1.5 rounded-full bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-500/20 backdrop-blur-md transition-colors">
              <div className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
              </div>
              <span className="text-[10px] uppercase tracking-[0.2em] font-medium text-red-600 dark:text-red-400">Restricted Access</span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight text-slate-900 dark:text-white leading-[1.1] transition-colors">
              Admin <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600 dark:from-red-400 dark:to-amber-500">Portal</span> <br />
              Secure Console
            </h1>
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-gray-400 font-light leading-relaxed max-w-md tracking-wide transition-colors">
              This area is restricted to Samiti administrators. Log in to manage members, record savings and loans, and configure bulk interest payouts.
            </p>
          </div>

          {/* Right: Admin Login Component */}
